...
<html lang="en">
  ...
  <div class="site-wrap">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 ml-auto order-md-2 align-self-start">
            ...
            <p><a href="{{ asset('views/catalog') }}" class="btn btn-black rounded-0">Shop Now</a></p>
            </div>
          </div>
    ...
    <div class="custom-border-bottom py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="{{ url('views/after_register') }}">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Shop</strong></div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-9 order-1">
            ...
            <div class="row mb-5">
              ...
              <div class="col-lg-6 col-md-6 item-entry mb-4">
                ...
                <h2 class="item-title"><a href="#">Tas</a></h2>
                <strong class="item-price">Rp 45.000.000</strong>
              </div>
            </div>
            <div class="row">
        ...
        <div class="row align-items-stretch">
          <div class="col-lg-8">
            <div class="product-item sm-height full-height bg-gray">
              <a href="{{ asset('views/catalog') }}" class="product-category">T-Shirt Uniqlo <span>25 items</span></a>
              <img src="{{ asset('after_register/images/Uniqlo.png') }}" alt="Image" class="img-fluid">
            </div>
          </div>
          <div class="col-lg-4">
            <div class="product-item sm-height bg-gray mb-4">
              <a href="{{ asset('views/catalog') }}" class="product-category">Jacket <span>25 items</span></a>
              <img src="{{ asset('after_register/images/jacket.png') }}" alt="Image" class="img-fluid">
            </div>
            <div class="product-item sm-height bg-gray">
              <a href="{{ asset('views/catalog') }}" class="product-category">Tas <span>25 items</span></a>
              <img src="{{ asset('after_register/images/tas4.png') }}" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
            ...
            <a href="#" class="block-6">
              <img src="{{ asset('after_register/images/uniqlo3.png') }}" alt="Image placeholder" class="img-fluid rounded mb-4">
